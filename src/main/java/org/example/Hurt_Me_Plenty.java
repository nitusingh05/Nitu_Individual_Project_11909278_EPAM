...
public class Hurt_Me_Plenty
{
    ...
    public static void openGcp(String url){
        driver.get(url);
    }
    ...
    public void GCPCal() throws InterruptedException, IOException {
        PropertiesOperation p = new PropertiesOperation();
        String search = p.getPropertyFileData("search");
